    ...
    render() {
        ...
        return (
            <>
                {
                    !this.state.isOpen && (
                        <button className="btn btn-primary  btn-sm configurator-button" onMouseEnter={this.handleMouseEnter} onClick={this.handleMouseEnter}>
                ...
                {
                    this.state.isOpen && (
                        <div style={{ position: 'relative', width: this.state.containerWidth }} className="parametersContainer" onMouseLeave={this.handleMouseLeave} onClick={this.handleMouseLeave}>
